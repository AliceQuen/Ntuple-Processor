...
JobScriptDir='/home/storage0/users/junkaiqin/Ntuple-Processor/JobScriptDir' # Directory to store Job Scripts, force to remove and re-create it
OutPutDir='/home/storage0/users/junkaiqin/Ntuple-Processor/Data/Data1' # Output directory, force to remove and re-create it
OutPutDiscription=' First 2016-2023 Data Test' # Discription of job, saved as .md file in OutPutDir
